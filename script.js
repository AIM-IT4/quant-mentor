...
// ================================
// FUTURISTIC LANDING PAGE EFFECTS
// ================================
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (typewriterElement) {
        const words = ["Quantitative Finance", "Derivatives Pricing", "XVA Modeling", "Python & C++", "Algo Trading"];
        let wordIndex = 0;
        let charIndex = 0;
        let isDeleting = false;
        let typeSpeed = 100;

        // Initialize with empty string to prevent jarring transition
